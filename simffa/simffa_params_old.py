...
filter1 = dict(
        initialize=dict(
            filter_shape=hp_choice('filter_shape1', [(3,3),(5,5),(7,7),(9,9)]),
            n_filters=hp_choice('n_filters1', [16,32,64]),
            generate=(
                'random:uniform',
...
l1_params = {'desc' : layers[:2], 'tag' : 'L1'}
l2_params = {'desc' : layers[:3], 'tag' : 'L2'}
l3_params = {'desc' : layers, 'tag' : 'L3'}
...
l1_params_gabor = {'desc' : layers_gabor[:2], 'tag' : 'l1g'}
l2_params_gabor = {'desc' : layers_gabor[:3], 'tag' : 'l2g'}
l3_params_gabor = {'desc' : layers_gabor, 'tag' : 'l3g'}

l1_params_gabor_larger = {'desc' : layers_gabor_larger[:2], 'tag' : 'l1g+'}
l2_params_gabor_larger = {'desc' : layers_gabor_larger[:3], 'tag' : 'l2g+'}
l3_params_gabor_larger = {'desc' : layers_gabor_larger, 'tag' : 'l3g+'}
